...
class WeGAN1to1(object):
    ...
    def generator(self, img_batch):
        with tf.variable_scope('g_') as vs:
            ...
            self.en_h0 = conv2d(img_batch, self.channels, 64, k_h=4, k_w=4, d_w=2, d_h=2, name="enc_conv1")
            ...
            self.en_h3 = conv2d(self.en_h1, 256, 512, k_h=4, k_w=4, d_w=2, d_h=2, name="enc_conv4")
            ...
            self.en_h4 = conv2d(self.en_h2, 512, 1024, k_h=4, k_w=4, d_w=2, d_h=2, name="enc_conv5")
